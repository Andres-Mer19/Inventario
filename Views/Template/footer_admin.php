    ...
    <?php } ?>
     <?php if($data['page_name'] == "entradas"){?>
     <script src="<?= media(); ?>/js/functions_entradas.js"></script>
    <?php } ?>
     <?php if($data['page_name'] == "merma"){?>
     <script src="<?= media(); ?>/js/functions_merma.js"></script>
    <?php } ?>
